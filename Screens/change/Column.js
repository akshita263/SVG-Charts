            ...
            <ScrollView style={styles.main}>
                <View style={styles.textContainer}>
                    ...
                    <Text style={styles.intro}> 
                        Columns work as well for showing change over time, but usually best at 
                        with only one series of data at a time.
                    </Text>
                </View>
