...
export default class PieChartEx extends React.PureComponent {
    render() {
        const data = [50, 10, 40, 95, 85, 91, 35, 53, 24, 50, 20]
        ...
        return (
            ...
            <View style={styles.textContainer}>
                <Text style={styles.head}>PIE CHART</Text>
                <Text style={styles.intro}> 
                    A common way to showing Part-To-Whole data- but be aware that its difficult to 
                    accurately co,pare the size of the segments
                </Text>
            </View>
            ...
            <View style={styles.textContainer}>
                ...
                <Text style={styles.list}> 
                     ...
                     percentage. Here, it is set to 0%.
                </Text>
